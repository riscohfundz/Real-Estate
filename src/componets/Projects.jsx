...
const Projects = () => {
    ...
    useEffect(()=>{
        const updatcardToShow = ()=>{
            ...
            window.addEventListener('resize', updatcardToShow);
            return ()=> window.removeEventListener('resize', updatcardToShow);
    }, [])
  ...
  return (
    ...
    className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
      ...
      <div className='overflow-hidden'>
        ...
        style={{transform: `translateX(-${(curentIndex * 100 ) / cardsToShow}% )`}}
        >
            {
